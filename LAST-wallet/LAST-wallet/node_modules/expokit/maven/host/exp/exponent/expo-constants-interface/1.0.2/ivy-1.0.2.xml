...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-constants-interface" revision="1.0.2" status="integration" publication="20180917171740"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-constants-interface" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-constants-interface" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
