...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-permissions-interface" revision="1.1.0" status="integration" publication="20180917171817"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-permissions-interface" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-permissions-interface" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
