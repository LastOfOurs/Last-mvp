...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-camera" revision="1.1.0" status="integration" publication="20180917171734"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-camera" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-camera" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    <dependency org="com.google.android.gms" name="play-services-vision" rev="15.0.2" conf="compile-&gt;default"/>
    <dependency org="com.android.support" name="exifinterface" rev="26.1.0" conf="compile-&gt;default"/>
    <dependency org="com.google.android" name="cameraview" rev="1.0.0" conf="compile-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-core" rev="1.1.0" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-barcode-scanner-interface" rev="1.0.0" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-face-detector-interface" rev="1.0.2" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-permissions-interface" rev="1.1.0" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-file-system-interface" rev="1.0.2" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-image-loader-interface" rev="1.0.0" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-camera-interface" rev="1.0.2" conf="implementation-&gt;default"/>
