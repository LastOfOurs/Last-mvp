...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-location" revision="1.0.0" status="integration" publication="20180917171806"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-location" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-location" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
