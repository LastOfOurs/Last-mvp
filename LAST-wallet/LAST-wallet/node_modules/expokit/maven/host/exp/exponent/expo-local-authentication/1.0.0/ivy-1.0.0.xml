...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-local-authentication" revision="1.0.0" status="integration" publication="20180917171804"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-local-authentication" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-local-authentication" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    <dependency org="host.exp.exponent" name="expo-core" rev="1.1.0" conf="implementation-&gt;default"/>
    <dependency org="com.android.support" name="support-compat" rev="27.1.1" conf="implementation-&gt;default"/>
