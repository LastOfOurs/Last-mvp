...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-face-detector" revision="1.0.2" status="integration" publication="20180917171746"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-face-detector" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-face-detector" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    <dependency org="com.android.support" name="exifinterface" rev="26.0.1" conf="compile-&gt;default"/>
