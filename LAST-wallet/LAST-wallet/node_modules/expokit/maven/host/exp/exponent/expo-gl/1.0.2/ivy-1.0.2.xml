...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-gl" revision="1.0.2" status="integration" publication="20180917171758"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-gl" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-gl" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    <dependency org="host.exp.exponent" name="expo-core" rev="1.1.0" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-gl-cpp" rev="1.0.2" conf="implementation-&gt;default"/>
