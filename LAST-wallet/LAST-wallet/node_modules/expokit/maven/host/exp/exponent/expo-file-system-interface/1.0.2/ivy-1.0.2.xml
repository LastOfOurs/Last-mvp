...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-file-system-interface" revision="1.0.2" status="integration" publication="20180917171752"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-file-system-interface" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-file-system-interface" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
