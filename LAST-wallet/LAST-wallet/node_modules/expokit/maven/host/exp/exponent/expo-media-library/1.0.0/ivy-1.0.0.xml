...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-media-library" revision="1.0.0" status="integration" publication="20180917171808"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-media-library" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-media-library" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
