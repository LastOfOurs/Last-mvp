...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-file-system" revision="1.0.2" status="integration" publication="20180917171750"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-file-system" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-file-system" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    ...
    <dependency org="com.squareup.okhttp3" name="okhttp" rev="3.10.0" conf="compile-&gt;default"/>
    <dependency org="com.squareup.okhttp3" name="okhttp-urlconnection" rev="3.10.0" conf="compile-&gt;default"/>
