...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-constants" revision="1.0.2" status="integration" publication="20180917171738"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-constants" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-constants" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    <dependency org="host.exp.exponent" name="expo-core" rev="1.1.0" conf="implementation-&gt;default"/>
    <dependency org="host.exp.exponent" name="expo-constants-interface" rev="1.0.2" conf="implementation-&gt;default"/>
    <dependency org="com.facebook.device.yearclass" name="yearclass" rev="2.1.0" conf="implementation-&gt;default"/>
    <dependency org="com.android.support" name="support-annotations" rev="+" conf="implementation-&gt;default"/>
