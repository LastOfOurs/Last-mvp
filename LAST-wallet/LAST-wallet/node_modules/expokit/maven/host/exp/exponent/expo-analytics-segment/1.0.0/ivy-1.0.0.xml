...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-analytics-segment" revision="1.0.0" status="integration" publication="20180917171823"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-analytics-segment" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-analytics-segment" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    <dependency org="com.segment.analytics.android" name="analytics" rev="4.3.0" conf="compile-&gt;default"/>
