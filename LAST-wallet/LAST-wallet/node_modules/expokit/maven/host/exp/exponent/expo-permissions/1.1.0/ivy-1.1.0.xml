...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="host.exp.exponent" module="expo-permissions" revision="1.1.0" status="integration" publication="20180917171815"/>
  <configurations>
  ...
  <publications>
    <artifact name="expo-permissions" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="expo-permissions" type="aar" ext="aar" conf="archives,default"/>
  </publications>
  <dependencies>
    ...
    <dependency org="com.android.support" name="appcompat-v7" rev="26.1.0" conf="implementation-&gt;default"/>
